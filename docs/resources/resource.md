...
- `gcp_billing_account` (Attributes) Remote info for a GCP billing account. Requires replacement if changed. (see [below for nested schema](#nestedatt--remote_info--gcp_billing_account))
...
- `github_enterprise_role` (Attributes) Remote info for GitHub Enterprise role. Requires replacement if changed. (see [below for nested schema](#nestedatt--remote_info--github_enterprise_role))
...
- `linear_organization` (Attributes) Remote info for Linear organization. Requires replacement if changed. (see [below for nested schema](#nestedatt--remote_info--linear_organization))
- `linear_project` (Attributes) Remote info for Linear project. Requires replacement if changed. (see [below for nested schema](#nestedatt--remote_info--linear_project))
...
- `ramp_fund` (Attributes) Remote info for Ramp fund. Requires replacement if changed. (see [below for nested schema](#nestedatt--remote_info--ramp_fund))
- `ramp_role` (Attributes) Remote info for Ramp built-in role. Requires replacement if changed. (see [below for nested schema](#nestedatt--remote_info--ramp_role))
...
- `billing_account_id` (String) The resource name of the billing account. Not Null; Requires replacement if changed.
...
<a id="nestedatt--remote_info--github_enterprise_role"></a>
### Nested Schema for `remote_info.github_enterprise_role`
...
- `org_id` (String) The ID of the Linear organization. Not Null; Requires replacement if changed.
...
- `project_id` (String) The ID of the Linear project. Not Null; Requires replacement if changed.
...
- `fund_id` (String) The ID of the Ramp fund. Not Null; Requires replacement if changed.
...
- `role` (String) The Ramp built-in role enum (e.g. BUSINESS_USER). Not Null; Requires replacement if changed.

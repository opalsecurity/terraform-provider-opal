...
func (r *IdpGroupMappingResourceModel) ToOperationsUpdateIdpGroupMappingsRequestBody() *operations.UpdateIdpGroupMappingsRequestBody {
...
func (r *IdpGroupMappingResourceModel) RefreshFromSharedIdpGroupMappingList(resp *shared.IdpGroupMappingList) {
	if resp != nil {

...
func (r *IdpGroupMappingsResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	request1, request1Diags := data.ToOperationsGetIdpGroupMappingsRequest(ctx)
	...
	resp.Diagnostics.Append(data.RefreshFromSharedIdpGroupMappingList(ctx, res1.IdpGroupMappingList)...)

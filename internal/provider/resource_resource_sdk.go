...
func (r *ResourceResourceModel) RefreshFromOperationsGetResourceVisibilityResponseBody(ctx context.Context, resp *operations.GetResourceVisibilityResponseBody) diag.Diagnostics {
...
func (r *ResourceResourceModel) RefreshFromSharedResource(ctx context.Context, resp *shared.Resource) diag.Diagnostics {
	...
	if resp != nil {
		...
		if resp.RemoteInfo == nil {
			...
			if resp.RemoteInfo.GrafanaDashboard == nil {
				r.RemoteInfo.GrafanaDashboard = nil
			} else {
				r.RemoteInfo.GrafanaDashboard = &tfTypes.GrafanaDashboard{}
				r.RemoteInfo.GrafanaDashboard.DashboardUID = types.StringValue(resp.RemoteInfo.GrafanaDashboard.DashboardUID)
			}
			if resp.RemoteInfo.GrafanaFolder == nil {
				r.RemoteInfo.GrafanaFolder = nil
			} else {
				r.RemoteInfo.GrafanaFolder = &tfTypes.GrafanaFolder{}
				r.RemoteInfo.GrafanaFolder.FolderUID = types.StringValue(resp.RemoteInfo.GrafanaFolder.FolderUID)
			}
			if resp.RemoteInfo.GrafanaRole == nil {
				r.RemoteInfo.GrafanaRole = nil
			} else {
...
func (r *ResourceResourceModel) ToOperationsGetResourceVisibilityRequest(ctx context.Context) (*operations.GetResourceVisibilityRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *ResourceResourceModel) ToSharedCreateResourceInfo(ctx context.Context) (*shared.CreateResourceInfo, diag.Diagnostics) {
	...
	if r.RemoteInfo != nil {
		...
		var awsRdsCluster *shared.AwsRdsCluster
		if r.RemoteInfo.AwsRdsCluster != nil {
			var accountId5 string
			accountId5 = r.RemoteInfo.AwsRdsCluster.AccountID.ValueString()

			var clusterID string
			clusterID = r.RemoteInfo.AwsRdsCluster.ClusterID.ValueString()

			var databaseName string
			databaseName = r.RemoteInfo.AwsRdsCluster.DatabaseName.ValueString()

			engine := shared.RDSEngineEnum(r.RemoteInfo.AwsRdsCluster.Engine.ValueString())
			var region1 string
			region1 = r.RemoteInfo.AwsRdsCluster.Region.ValueString()

			var resourceID string
			resourceID = r.RemoteInfo.AwsRdsCluster.ResourceID.ValueString()

			awsRdsCluster = &shared.AwsRdsCluster{
		...
		if r.RemoteInfo.AwsRdsInstance != nil {
			...
			resourceId1 = r.RemoteInfo.AwsRdsInstance.ResourceID.ValueString()
		...
		if r.RemoteInfo.AzureEnterpriseApp != nil {
			...
			resourceId2 = r.RemoteInfo.AzureEnterpriseApp.ResourceID.ValueString()
		...
		if r.RemoteInfo.AzureEntraIDRole != nil {
			...
			resourceId3 = r.RemoteInfo.AzureEntraIDRole.ResourceID.ValueString()
		...
		if r.RemoteInfo.AzureManagementGroup != nil {
			...
			resourceId4 = r.RemoteInfo.AzureManagementGroup.ResourceID.ValueString()
		...
		if r.RemoteInfo.AzureResourceGroup != nil {
			...
			resourceId5 = r.RemoteInfo.AzureResourceGroup.ResourceID.ValueString()
		...
		if r.RemoteInfo.AzureSQLDatabase != nil {
			...
			resourceId6 = r.RemoteInfo.AzureSQLDatabase.ResourceID.ValueString()
		...
		if r.RemoteInfo.AzureSQLManagedDatabase != nil {
			...
			resourceId7 = r.RemoteInfo.AzureSQLManagedDatabase.ResourceID.ValueString()
		...
		if r.RemoteInfo.AzureSQLManagedInstance != nil {
			...
			resourceId8 = r.RemoteInfo.AzureSQLManagedInstance.ResourceID.ValueString()
		...
		if r.RemoteInfo.AzureSQLServer != nil {
			...
			resourceId9 = r.RemoteInfo.AzureSQLServer.ResourceID.ValueString()
		...
		if r.RemoteInfo.AzureStorageAccount != nil {
			...
			resourceId10 = r.RemoteInfo.AzureStorageAccount.ResourceID.ValueString()
		...
		if r.RemoteInfo.AzureStorageContainer != nil {
			...
			resourceId11 = r.RemoteInfo.AzureStorageContainer.ResourceID.ValueString()
		...
		if r.RemoteInfo.AzureSubscription != nil {
			...
			resourceId12 = r.RemoteInfo.AzureSubscription.ResourceID.ValueString()
		...
		if r.RemoteInfo.AzureUserAssignedManagedIdentity != nil {
			...
			resourceId13 = r.RemoteInfo.AzureUserAssignedManagedIdentity.ResourceID.ValueString()
		...
		if r.RemoteInfo.AzureVirtualMachine != nil {
			var resourceId14 string
			resourceId14 = r.RemoteInfo.AzureVirtualMachine.ResourceID.ValueString()
		...
		if r.RemoteInfo.ClickhouseConsoleRole != nil {
			var roleID string
			roleID = r.RemoteInfo.ClickhouseConsoleRole.RoleID.ValueString()
		...
		if r.RemoteInfo.CoupaRole != nil {
			var roleId1 string
			roleId1 = r.RemoteInfo.CoupaRole.RoleID.ValueString()
		...
		var databricksAccountServicePrincipal *shared.DatabricksAccountServicePrincipal
		if r.RemoteInfo.DatabricksAccountServicePrincipal != nil {
			var applicationID string
			applicationID = r.RemoteInfo.DatabricksAccountServicePrincipal.ApplicationID.ValueString()

			var resourceId15 string
			resourceId15 = r.RemoteInfo.DatabricksAccountServicePrincipal.ResourceID.ValueString()

			databricksAccountServicePrincipal = &shared.DatabricksAccountServicePrincipal{
		...
		if r.RemoteInfo.DatadogRole != nil {
			var roleId2 string
			roleId2 = r.RemoteInfo.DatadogRole.RoleID.ValueString()
		...
		if r.RemoteInfo.DatastaxAstraRole != nil {
			var roleId3 string
			roleId3 = r.RemoteInfo.DatastaxAstraRole.RoleID.ValueString()
		...
		if r.RemoteInfo.DevinRole != nil {
			var roleId4 string
			roleId4 = r.RemoteInfo.DevinRole.RoleID.ValueString()
		...
		if r.RemoteInfo.GithubEnterpriseRole != nil {
			var roleId5 string
			roleId5 = r.RemoteInfo.GithubEnterpriseRole.RoleID.ValueString()
		...
		if r.RemoteInfo.GithubOrgRole != nil {
			...
			var roleId6 string
			roleId6 = r.RemoteInfo.GithubOrgRole.RoleID.ValueString()
		...
		if r.RemoteInfo.GoogleWorkspaceRole != nil {
			var roleId7 string
			roleId7 = r.RemoteInfo.GoogleWorkspaceRole.RoleID.ValueString()
		...
		if r.RemoteInfo.GrafanaDashboard != nil {
			var dashboardUID string
			dashboardUID = r.RemoteInfo.GrafanaDashboard.DashboardUID.ValueString()

			grafanaDashboard = &shared.GrafanaDashboard{
				DashboardUID: dashboardUID,
			}
		}
		var grafanaFolder *shared.GrafanaFolder
		if r.RemoteInfo.GrafanaFolder != nil {
			var folderUID string
			folderUID = r.RemoteInfo.GrafanaFolder.FolderUID.ValueString()

			grafanaFolder = &shared.GrafanaFolder{
				FolderUID: folderUID,
			}
		}
		var grafanaRole *shared.GrafanaRole
		if r.RemoteInfo.GrafanaRole != nil {
			var roleUID string
			roleUID = r.RemoteInfo.GrafanaRole.RoleUID.ValueString()

			grafanaRole = &shared.GrafanaRole{
				RoleUID: roleUID,
			}
		}
		...
		if r.RemoteInfo.HubspotRole != nil {
			var roleId8 string
			roleId8 = r.RemoteInfo.HubspotRole.RoleID.ValueString()
		...
		if r.RemoteInfo.IlevelAdvancedRole != nil {
			var roleName string
			roleName = r.RemoteInfo.IlevelAdvancedRole.RoleName.ValueString()

			ilevelAdvancedRole = &shared.IlevelAdvancedRole{
				RoleName: roleName,
			}
		}
		...
		if r.RemoteInfo.NetsuiteRole != nil {
			var roleId9 string
			roleId9 = r.RemoteInfo.NetsuiteRole.RoleID.ValueString()
		...
		if r.RemoteInfo.OktaCustomRole != nil {
			var roleId10 string
			roleId10 = r.RemoteInfo.OktaCustomRole.RoleID.ValueString()
		...
		if r.RemoteInfo.OracleFusionRole != nil {
			var roleId11 string
			roleId11 = r.RemoteInfo.OracleFusionRole.RoleID.ValueString()
		...
		if r.RemoteInfo.PagerdutyRole != nil {
			...
			roleName1 = r.RemoteInfo.PagerdutyRole.RoleName.ValueString()
		...
		if r.RemoteInfo.SalesforceRole != nil {
			var roleId12 string
			roleId12 = r.RemoteInfo.SalesforceRole.RoleID.ValueString()
		...
		if r.RemoteInfo.TailscaleSSH != nil {
			var tagName string
			tagName = r.RemoteInfo.TailscaleSSH.TagName.ValueString()

			tailscaleSSH = &shared.TailscaleSSH{
				TagName: tagName,
			}
		}
		...
		if r.RemoteInfo.TeleportRole != nil {
			...
			roleName2 = r.RemoteInfo.TeleportRole.RoleName.ValueString()
		...
		if r.RemoteInfo.VercelRole != nil {
			var roleId13 string
			roleId13 = r.RemoteInfo.VercelRole.RoleID.ValueString()
		...
		if r.RemoteInfo.WorkdayRole != nil {
			var roleId14 string
			roleId14 = r.RemoteInfo.WorkdayRole.RoleID.ValueString()
		...
		if r.RemoteInfo.ZendeskRole != nil {
			var roleId15 string
			roleId15 = r.RemoteInfo.ZendeskRole.RoleID.ValueString()
		...
		if r.RemoteInfo.ZoomRole != nil {
			var roleId16 string
			roleId16 = r.RemoteInfo.ZoomRole.RoleID.ValueString()

...
func (r *DelegationResourceModel) ToOperationsGetDelegationRequest(ctx context.Context) (*operations.GetDelegationRequest, diag.Diagnostics) {
	var diags diag.Diagnostics

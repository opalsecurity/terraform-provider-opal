...
var _ datasource.DataSourceWithConfigure = &DelegationDataSource{}

func NewDelegationDataSource() datasource.DataSource {
	return &DelegationDataSource{}
}

// DelegationDataSource is the data source implementation.
type DelegationDataSource struct {
	// Provider configured SDK client.
	client *sdk.OpalAPI
}

// DelegationDataSourceModel describes the data model.
...
func (r *DelegationDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_delegation"
}

// Schema defines the schema for the data source.
func (r *DelegationDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Delegation DataSource",
...
func (r *DelegationDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *DelegationDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *DelegationDataSourceModel

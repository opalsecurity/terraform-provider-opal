...
func (r *DelegationListDataSourceModel) RefreshFromSharedDelegation(ctx context.Context, resp *shared.Delegation) diag.Diagnostics {
...
func (r *DelegationListDataSourceModel) ToOperationsGetDelegationRequest(ctx context.Context) (*operations.GetDelegationRequest, diag.Diagnostics) {
	var diags diag.Diagnostics

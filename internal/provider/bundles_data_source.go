...
var _ datasource.DataSource = &BundlesDataSource{}
var _ datasource.DataSourceWithConfigure = &BundlesDataSource{}

func NewBundlesDataSource() datasource.DataSource {
	return &BundlesDataSource{}
}

// BundlesDataSource is the data source implementation.
type BundlesDataSource struct {
	client *sdk.OpalAPI
}

// BundlesDataSourceModel describes the data model.
...
func (r *BundlesDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_bundles"
}

// Schema defines the schema for the data source.
func (r *BundlesDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Bundles DataSource",
...
func (r *BundlesDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *BundlesDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *BundlesDataSourceModel

...
func (r *GroupCatalogMappingResourceModel) RefreshFromSharedIdpGroupMapping(ctx context.Context, resp *shared.IdpGroupMapping) diag.Diagnostics {
...
func (r *GroupCatalogMappingResourceModel) ToOperationsCreateIdpGroupMappingRequest(ctx context.Context) (*operations.CreateIdpGroupMappingRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *GroupCatalogMappingResourceModel) ToOperationsCreateIdpGroupMappingRequestBody(ctx context.Context) (*operations.CreateIdpGroupMappingRequestBody, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *GroupCatalogMappingResourceModel) ToOperationsDeleteIdpGroupMappingsRequest(ctx context.Context) (*operations.DeleteIdpGroupMappingsRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *GroupCatalogMappingResourceModel) ToOperationsGetIdpGroupMappingRequest(ctx context.Context) (*operations.GetIdpGroupMappingRequest, diag.Diagnostics) {
	var diags diag.Diagnostics

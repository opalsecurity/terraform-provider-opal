	...
	if resp != nil {
		...
		for _, resultsItem := range resp.Results {
			...
			if resultsItem.RemoteInfo == nil {
				...
				if resultsItem.RemoteInfo.AxiomGroup == nil {
					results.RemoteInfo.AxiomGroup = nil
				} else {
					results.RemoteInfo.AxiomGroup = &tfTypes.ActiveDirectoryGroup{}
					results.RemoteInfo.AxiomGroup.GroupID = types.StringValue(resultsItem.RemoteInfo.AxiomGroup.GroupID)
				}
				...
				if resultsItem.RemoteInfo.GrafanaTeam == nil {
					results.RemoteInfo.GrafanaTeam = nil
				} else {
				...
				if resultsItem.RemoteInfo.TwingateGroupSynced == nil {
					results.RemoteInfo.TwingateGroupSynced = nil
				} else {
					results.RemoteInfo.TwingateGroupSynced = &tfTypes.ActiveDirectoryGroup{}
					results.RemoteInfo.TwingateGroupSynced.GroupID = types.StringValue(resultsItem.RemoteInfo.TwingateGroupSynced.GroupID)
				}
				...
				if resultsItem.RemoteInfo.WrikeGroup == nil {
					results.RemoteInfo.WrikeGroup = nil
				} else {
					results.RemoteInfo.WrikeGroup = &tfTypes.ActiveDirectoryGroup{}
					results.RemoteInfo.WrikeGroup.GroupID = types.StringValue(resultsItem.RemoteInfo.WrikeGroup.GroupID)
				}

...
func newNonHumanIdentities(rootSDK *OpalAPI, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *NonHumanIdentities {
	return &NonHumanIdentities{
		rootSDK:          rootSDK,
...
func (s *NonHumanIdentities) GetNhis(ctx context.Context, request operations.GetNhisRequest, opts ...operations.Option) (*operations.GetNhisResponse, error) {
	...
	res := &operations.GetNhisResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	res.Next = func() (*operations.GetNhisResponse, error) {

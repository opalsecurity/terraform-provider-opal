...
// ScopedRolePermissions - Operations related to scoped role permissions
type ScopedRolePermissions struct {
	rootSDK          *OpalAPI
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newScopedRolePermissions(rootSDK *OpalAPI, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *ScopedRolePermissions {

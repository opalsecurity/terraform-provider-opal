...
// DeleteUser - Deletes a user from your organization.
...
// GetUserWhoami - Returns the user that the provided API token authenticates as.
func (s *Users) GetUserWhoami(ctx context.Context, opts ...operations.Option) (*operations.GetUserWhoamiResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	opURL, err := url.JoinPath(baseURL, "/users/whoami")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.GetUserWhoamiResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
// InviteUser - Invites a user to your organization.
func (s *Users) InviteUser(ctx context.Context, request shared.InviteUserInfo, opts ...operations.Option) (*operations.InviteUserResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
...
// UpdateUser - Updates a user's position or manager.
func (s *Users) UpdateUser(ctx context.Context, request operations.UpdateUserRequest, opts ...operations.Option) (*operations.UpdateUserResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "UpdateUserInfo", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}

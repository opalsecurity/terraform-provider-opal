...
// Generated from OpenAPI doc version 1.0 and generator version 2.755.6
...
func New(opts ...SDKOption) *OpalAPI {
	sdk := &OpalAPI{
		SDKVersion: "3.3.4",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/terraform 3.3.4 2.755.6 1.0 github.com/opalsecurity/terraform-provider-opal/v3/internal/sdk",

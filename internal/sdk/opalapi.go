...
// @generated-id: 115b79f30ba9

package sdk

// Generated from OpenAPI doc version 1.0 and generator version 2.845.21
...
func New(opts ...SDKOption) *OpalAPI {
	sdk := &OpalAPI{
		SDKVersion: "3.4.4",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/terraform 3.4.4 2.845.21 1.0 github.com/opalsecurity/terraform-provider-opal/v3/internal/sdk",

...
// Generated from OpenAPI doc version 1.0 and generator version 2.903.2
...
func New(opts ...SDKOption) *OpalAPI {
	sdk := &OpalAPI{
		SDKVersion: "3.5.3",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/terraform 3.5.3 2.903.2 1.0 github.com/opalsecurity/terraform-provider-opal/v3/internal/sdk",

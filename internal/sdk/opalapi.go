...
// Generated from OpenAPI doc version 1.0 and generator version 2.677.3
...
func New(opts ...SDKOption) *OpalAPI {
	sdk := &OpalAPI{
		SDKVersion: "3.2.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/terraform 3.2.0 2.677.3 1.0 github.com/opalsecurity/terraform-provider-opal/v3/internal/sdk",

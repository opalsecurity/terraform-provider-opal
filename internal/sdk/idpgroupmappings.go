...
func newIdpGroupMappings(rootSDK *OpalAPI, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *IdpGroupMappings {
...
func (s *IdpGroupMappings) CreateIdpGroupMapping(ctx context.Context, request operations.CreateIdpGroupMappingRequest, opts ...operations.Option) (*operations.CreateIdpGroupMappingResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/idp-group-mappings/{app_resource_id}/groups/{group_id}", request, nil)
	if err != nil {
	...
	res := &operations.CreateIdpGroupMappingResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.IdpGroupMapping
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.IdpGroupMapping = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
// GetIdpGroupMapping - Gets an `IdpGroupMapping` object for an Okta app and group.
func (s *IdpGroupMappings) GetIdpGroupMapping(ctx context.Context, request operations.GetIdpGroupMappingRequest, opts ...operations.Option) (*operations.GetIdpGroupMappingResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	res := &operations.GetIdpGroupMappingResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
//
// Deprecated: This resource is deprecated. Use the `opal_group_catalog_mapping` resource instead..

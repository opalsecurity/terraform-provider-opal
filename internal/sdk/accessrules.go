...
func newAccessRules(sdkConfig sdkConfiguration) *AccessRules {
	return &AccessRules{
...
func (s *AccessRules) GetAccessRule(ctx context.Context, request operations.GetAccessRuleRequest, opts ...operations.Option) (*operations.GetAccessRuleResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.AccessRuleCondition
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.AccessRuleCondition = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *AccessRules) UpdateAccessRule(ctx context.Context, request operations.UpdateAccessRuleRequest, opts ...operations.Option) (*operations.UpdateAccessRuleResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "AccessRuleCondition", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}

...
// DeleteBundleResource - Removes a resource from a bundle.
func (s *Bundles) DeleteBundleResource(ctx context.Context, request operations.RemoveBundleResourceRequest, opts ...operations.Option) (*operations.RemoveBundleResourceResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
...
// UpdateBundleVisibility - Sets the visibility of the bundle.
func (s *Bundles) UpdateBundleVisibility(ctx context.Context, request operations.SetBundleVisibilityRequest, opts ...operations.Option) (*operations.SetBundleVisibilityResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,

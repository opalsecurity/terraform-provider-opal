...
// CreateCustomAccessLevel - Creates a custom access level on a resource. If the resource is a parent type, the role is created on all child resources.
func (s *Resources) CreateCustomAccessLevel(ctx context.Context, request operations.CreateResourceCustomAccessLevelRequest, opts ...operations.Option) (*operations.CreateResourceCustomAccessLevelResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "createResourceCustomAccessLevel",
		OAuth2Scopes:     nil,
		SecuritySource:   s.sdkConfiguration.Security,
	}
...
// DeleteCustomAccessLevel - Deletes a custom access level identified by its remote ID. If the resource is a parent type, the deletion fans out to all child resources.
func (s *Resources) DeleteCustomAccessLevel(ctx context.Context, request operations.DeleteResourceCustomAccessLevelRequest, opts ...operations.Option) (*operations.DeleteResourceCustomAccessLevelResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "deleteResourceCustomAccessLevel",
		OAuth2Scopes:     nil,
		SecuritySource:   s.sdkConfiguration.Security,
	}
...
// GetCustomAccessLevels - Returns all custom access levels for a resource. If the resource is a parent type (e.g. GitHubOrg), returns aggregated roles across child resources.
func (s *Resources) GetCustomAccessLevels(ctx context.Context, request operations.GetResourceCustomAccessLevelsRequest, opts ...operations.Option) (*operations.GetResourceCustomAccessLevelsResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "getResourceCustomAccessLevels",
		OAuth2Scopes:     nil,
		SecuritySource:   s.sdkConfiguration.Security,
	}
...
// UpdateCustomAccessLevel - Updates a custom access level identified by its remote ID. If the resource is a parent type, the update fans out to all child resources.
func (s *Resources) UpdateCustomAccessLevel(ctx context.Context, request operations.UpdateResourceCustomAccessLevelRequest, opts ...operations.Option) (*operations.UpdateResourceCustomAccessLevelResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "updateResourceCustomAccessLevel",
		OAuth2Scopes:     nil,
		SecuritySource:   s.sdkConfiguration.Security,
	}

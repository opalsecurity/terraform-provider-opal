...
func (s *Resources) GetResourceScopedRolePermissions(ctx context.Context, request operations.GetResourceScopedRolePermissionsRequest, opts ...operations.Option) (*operations.GetResourceScopedRolePermissionsResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
...
func (s *Resources) SetResourceScopedRolePermissions(ctx context.Context, request operations.SetResourceScopedRolePermissionsRequest, opts ...operations.Option) (*operations.SetResourceScopedRolePermissionsResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,

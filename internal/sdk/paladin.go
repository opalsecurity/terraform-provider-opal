...
// Paladin - Operations related to Paladin
type Paladin struct {
	rootSDK          *OpalAPI
...
func newPaladin(rootSDK *OpalAPI, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Paladin {
	return &Paladin{
		rootSDK:          rootSDK,
...
func (s *Paladin) CreatePaladin(ctx context.Context, request shared.CreatePaladinInfo, opts ...operations.Option) (*operations.CreatePaladinResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/paladin")
	if err != nil {
	...
	res := &operations.CreatePaladinResponse{
...
func (s *Paladin) CreatePaladinContextSource(ctx context.Context, request operations.CreatePaladinContextSourceRequest, opts ...operations.Option) (*operations.CreatePaladinContextSourceResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/paladin/{paladin_id}/context-sources", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "CreatePaladinContextSourceInfo", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
	...
	res := &operations.CreatePaladinContextSourceResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.PaladinContextSource
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.PaladinContextSource = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *Paladin) DeletePaladin(ctx context.Context, request operations.DeletePaladinRequest, opts ...operations.Option) (*operations.DeletePaladinResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/paladin/{paladin_id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.DeletePaladinResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
func (s *Paladin) DeletePaladinContextSource(ctx context.Context, request operations.DeletePaladinContextSourceRequest, opts ...operations.Option) (*operations.DeletePaladinContextSourceResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/paladin/{paladin_id}/context-sources/{context_source_id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.DeletePaladinContextSourceResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
func (s *Paladin) GetPaladin(ctx context.Context, request operations.GetPaladinRequest, opts ...operations.Option) (*operations.GetPaladinResponse, error) {
	...
	res := &operations.GetPaladinResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
func (s *Paladin) GetPaladinFromName(ctx context.Context, request operations.GetPaladinFromNameRequest, opts ...operations.Option) (*operations.GetPaladinFromNameResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/paladin/name/{paladin_name}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.GetPaladinFromNameResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
func (s *Paladin) ListPaladinContextSources(ctx context.Context, request operations.ListPaladinContextSourcesRequest, opts ...operations.Option) (*operations.ListPaladinContextSourcesResponse, error) {
	...
	res := &operations.ListPaladinContextSourcesResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.PaladinContextSourceList
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.PaladinContextSourceList = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *Paladin) UpdatePaladin(ctx context.Context, request operations.UpdatePaladinRequest, opts ...operations.Option) (*operations.UpdatePaladinResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "UpdatePaladinInfo", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
	...
	res := &operations.UpdatePaladinResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}

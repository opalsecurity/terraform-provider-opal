...
// Delegations - Operations related to request reviewer delegations
...
func newDelegations(rootSDK *OpalAPI, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Delegations {
	return &Delegations{
		rootSDK:          rootSDK,
...
// CreateDelegation - Creates a new request reviewer delegation to delegate access review requests from one user to another.
func (s *Delegations) CreateDelegation(ctx context.Context, request shared.CreateDelegationRequest, opts ...operations.Option) (*operations.CreateDelegationResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/delegations")
	if err != nil {
	...
	res := &operations.CreateDelegationResponse{
...
// DeleteDelegation - Deletes a delegation by its ID.
func (s *Delegations) DeleteDelegation(ctx context.Context, request operations.DeleteDelegationRequest, opts ...operations.Option) (*operations.DeleteDelegationResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/delegations/{delegation_id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.DeleteDelegationResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
func (s *Delegations) GetDelegation(ctx context.Context, request operations.GetDelegationRequest, opts ...operations.Option) (*operations.GetDelegationResponse, error) {
	...
	res := &operations.GetDelegationResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
func (s *Delegations) GetDelegations(ctx context.Context, request operations.GetDelegationsRequest, opts ...operations.Option) (*operations.GetDelegationsResponse, error) {
	...
	res.Next = func() (*operations.GetDelegationsResponse, error) {
		rawBody, err := utils.ConsumeRawBody(httpRes)
		if err != nil {
			return nil, err
		}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.PaginatedDelegationsList
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.PaginatedDelegationsList = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err

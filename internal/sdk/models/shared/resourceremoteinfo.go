...
// AxiomCustomRole - Remote info for Axiom custom RBAC role.
type AxiomCustomRole struct {
	// The ID of the Axiom custom role.
	RoleID string `json:"role_id"`
}

func (a *AxiomCustomRole) GetRoleID() string {
	if a == nil {
		return ""
	}
	return a.RoleID
...
// AxiomRole - Remote info for Axiom base role.
type AxiomRole struct {
	// The ID of the Axiom base role.
	RoleID string `json:"role_id"`
}

func (a *AxiomRole) GetRoleID() string {
	if a == nil {
		return ""
	}
	return a.RoleID
...
// DocusignPermissionProfile - Remote info for Docusign permission profile.
...
func (d *DocusignPermissionProfile) GetPermissionProfileID() string {
	if d == nil {
		return ""
	}
	return d.PermissionProfileID
}
...
// GrafanaDashboard - Remote info for Grafana dashboard.
type GrafanaDashboard struct {
	// The UID of the Grafana dashboard.
	DashboardUID string `json:"dashboard_uid"`
}

func (g *GrafanaDashboard) GetDashboardUID() string {
	if g == nil {
		return ""
	}
...
// GrafanaFolder - Remote info for Grafana folder.
type GrafanaFolder struct {
	// The UID of the Grafana folder.
	FolderUID string `json:"folder_uid"`
}

func (g *GrafanaFolder) GetFolderUID() string {
	if g == nil {
		return ""
	}
	return g.FolderUID
...
// GrafanaRole - Remote info for Grafana role(fixed or custom).
type GrafanaRole struct {
	// The UID of the Grafana role.
	RoleUID string `json:"role_uid"`
}

func (g *GrafanaRole) GetRoleUID() string {
	if g == nil {
		return ""
	}
	return g.RoleUID
...
type NetsuiteRole struct {
	// The id of the role.
	RoleID string `json:"role_id"`
}

func (n *NetsuiteRole) GetRoleID() string {
	if n == nil {
		return ""
	}
	return n.RoleID
...
type ResourceRemoteInfo struct {
	...
	AxiomCustomRole *AxiomCustomRole `json:"axiom_custom_role,omitempty"`
	// Remote info for Axiom base role.
	AxiomRole *AxiomRole `json:"axiom_role,omitempty"`
	...
	DocusignPermissionProfile *DocusignPermissionProfile `json:"docusign_permission_profile,omitempty"`
	...
	GrafanaDashboard *GrafanaDashboard `json:"grafana_dashboard,omitempty"`
...
func (r *ResourceRemoteInfo) GetAxiomCustomRole() *AxiomCustomRole {
	if r == nil {
		return nil
	}
	return r.AxiomCustomRole
}

func (r *ResourceRemoteInfo) GetAxiomRole() *AxiomRole {
	if r == nil {
		return nil
	}
	return r.AxiomRole
...
func (r *ResourceRemoteInfo) GetDocusignPermissionProfile() *DocusignPermissionProfile {
	if r == nil {
		return nil
	}
	return r.DocusignPermissionProfile
}
...
func (r *ResourceRemoteInfo) GetGrafanaDashboard() *GrafanaDashboard {
	if r == nil {
		return nil
	}
	return r.GrafanaDashboard
}

func (r *ResourceRemoteInfo) GetGrafanaFolder() *GrafanaFolder {
	if r == nil {
		return nil
	}
	return r.GrafanaFolder
}

func (r *ResourceRemoteInfo) GetGrafanaRole() *GrafanaRole {
	if r == nil {
		return nil
	}

...
// Tokens - Operations related to API tokens
type Tokens struct {
	rootSDK          *OpalAPI
...
func newTokens(rootSDK *OpalAPI, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Tokens {
	return &Tokens{
		rootSDK:          rootSDK,
...
func (s *Tokens) GetTokens(ctx context.Context, request operations.GetTokensRequest, opts ...operations.Option) (*operations.GetTokensResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.PaginatedTokensList
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.PaginatedTokensList = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
